	...
	return (
		<div>
			...
			<footer className="bg-white text-black py-12 border-t border-gray-300">
				<div className="container mx-auto px-6 md:px-16 lg:px-24">
					<div className="flex flex-col items-left">
						{/* Logo */}
						{/* Navigation */}
						<div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 text-left md:text-center">
							<div className="mb-10">
								<Link href="/">
									<Image
			...
			<footer className="bg-white text-black py-0 border-t border-gray-300">
				{/* Footer Bottom */}
				<div className="bg-white py-4 px-6 flex flex-col md:flex-row justify-around items-center text-center md:text-left">
					{/* Copyright */}
					<p className="text-sm text-center md:text-left text-gray-500 mb-4 md:mb-0">
