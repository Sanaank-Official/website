...
<div className="bg-[rgb(240,244,253)] py-20"> {/* Increased section height */}
  <div className="container mx-auto px-8 md:px-16 lg:px-24">
    ...
    {/* Features Grid */}
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10"> {/* Increased gap between rows */}
      {/* Feature 1 */}
      <div className="flex items-center gap-6"> {/* Closer spacing */}
        ...
        <div>
          <h3 className="text-lg font-bold text-gray-800 text-left">HD Sounds</h3>
      ...
      <div className="flex items-center gap-6">
        ...
        <div>
          <h3 className="text-lg font-bold text-gray-800 text-left">Playlist</h3>
          <p className="text-base text-gray-600 text-left">
            Lorem ipsum dolor sit amet, consectetur adipiscing elit.
          </p>
        </div>
      ...
      <div className="flex items-center gap-6">
        ...
        <div>
          <h3 className="text-lg font-bold text-gray-800 text-left">Favorites</h3>
          <p className="text-base text-gray-600 text-left">
            Lorem ipsum dolor sit amet, consectetur adipiscing elit.
          </p>
        </div>
      ...
      <div className="flex items-center gap-6">
        <div className="bg-purple-500 text-white rounded-full w-20 h-20 flex items-center justify-center text-3xl">
          <i className="fas fa-heartbeat"></i> {/* Icon */}
        </div>
        <div>
          <h3 className="text-lg font-bold text-gray-800 text-left">Mood Detector</h3>
          <p className="text-base text-gray-600 text-left">
            Lorem ipsum dolor sit amet, consectetur adipiscing elit.
          </p>
        </div>
      ...
      <div className="flex items-center gap-6">
        ...
        <div>
          <h3 className="text-lg font-bold text-gray-800 text-left">Shuffle</h3>
          <p className="text-base text-gray-600 text-left">
            Lorem ipsum dolor sit amet, consectetur adipiscing elit.
          </p>
        </div>
      ...
      <div className="flex items-center gap-6">
        ...
        <div>
          <h3 className="text-lg font-bold text-gray-800 text-left">Timer</h3>
          <p className="text-base text-gray-600 text-left">
            Lorem ipsum dolor sit amet, consectetur adipiscing elit.
          </p>
        </div>
          ...
          <div className="flex items-center">
            ...
            <div className="max-w-xl">
              ...
              <div className="flex space-x-4">
                ...
                <a href="#" className="btn btn-secondary animate-bounce">
                  DOWNLOAD
                </a>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
            <div className="bg-gray-100 rounded-lg p-6 animate-fade-in">
              ...
              <p className="text-gray-600">
                Elaxo is a productivity app designed to help you focus and
  ...
  <div className="container mx-auto px-8 md:px-16 lg:px-24">
    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
      ...
      <div className="bg-[#f0f4fd] rounded-lg p-6 shadow-md cursor-pointer hover:shadow-lg transform transition-all duration-300">
        ...
        {/* "Excellent" text */}
        <p className="font-bold text-lg text-gray-800 mb-4">Excellent</p>
        {/* Review text */}
        <p className="mb-4 text-gray-700">
          "Elaxo has been a game-changer for my productivity. I highly recommend it!"
        </p>
      </div>
      ...
      <div className="bg-[#f0f4fd] rounded-lg p-6 shadow-md cursor-pointer hover:shadow-lg transform transition-all duration-300">
        ...
        {/* Review text */}
        <p className="mb-4 text-gray-700">
          "A fantastic tool for streamlining my workflow. Highly recommended!"
        </p>
      </div>
      ...
      <div className="bg-[#f0f4fd] rounded-lg p-6 shadow-md cursor-pointer hover:shadow-lg transform transition-all duration-300">
        ...
        {/* Review text */}
        <p className="mb-4 text-gray-700">
          "Using this app has increased my efficiency by 50%. It's a must-have!"
        </p>
      </div>
    </div>
...
{/* Download Section */}
<div className="bg-[#f7f8fc] py-16 flex items-center justify-center"> {/* Center-align the entire section */}
  <div className="container mx-auto flex flex-col lg:flex-row items-center gap-8"> {/* Flexbox for alignment */}
    ...
    <div className="flex flex-col items-center lg:items-start text-center lg:text-left">
      ...
      <p className="text-gray-600 leading-relaxed mb-8">
        ...
        laudantium, totam rem aperiam, eaque ipsa quae <br />
