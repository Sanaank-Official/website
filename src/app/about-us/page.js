        ...
        <div className="container mx-auto flex flex-col md:flex-row items-center">
          ...
          <div className="md:w-1/2">
            ...
            <p className="text-lg text-gray-600 leading-relaxed text-left">
              At Sanaank, we believe that knowledge is more than power—it's a
              gateway to endless possibilities. We are a mobile gaming platform
              dedicated to turning your love for learning and trivia into
              real-world rewards.
            </p>
          </div>
        </div>
        ...
        <div className="container mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              {
                icon: <Trophy className="w-12 h-12 text-yellow-600 mb-4" />,
                title: "Why Sanaank",
                description:
      ...
      >
        <div className="container mx-auto text-center">
          ...
          <p className="text-lg text-gray-600 leading-relaxed max-w-3xl mx-auto">
            ...
            participant feels valued, inspired, and rewarded for their unique
      ...
      >
        <div className="container mx-auto text-center">
          ...
          <motion.button
            ...
            viewport={{ once: true }}
            transition={{ duration: 0.6 }}
            className="bg-white text-gray-800 hover:bg-gray-100 font-bold py-3 px-8 rounded-full transition duration-300 ease-in-out"
          >
            Get Started
          </motion.button>
        </div>
